...
class WCISPluginWidget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$form .=        '<input type="text" name="s" class="isp_search_box_input" placeholder="'.$search_box_inner_text.'" autocomplete="off" autocorrect="off" autocapitalize="off" style="outline: none; width:'.$search_box_width_input.$search_box_units.'; height:'.$search_box_height.$search_box_units.';">';
