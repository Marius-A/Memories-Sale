...
Tags: search, autocomplete, suggest, woocommerce, instant search, autosuggest, better search, product search, custom search, relevant search, category search, typeahead, woocommerce search, woocommerce product search, did you mean, e-commerce, live search, wordpress ecommerce, highlight terms, search highlight, search product, predictive search, woocommerce plugin, best search, instant-search, search plugin, advance search, ajax search, brilliant search, ecommerce search, products search, search widget, search by sku, filters, facets, search filters, search by tag, search tag, search custom attribute, WooCommerce search plugin, woocommerce advanced search,best woocommerce search plugin,search by brand, woothemes, woocomerce search filters, fastest woocommerce search, woocommerce store, products, relevant search, shop, themes, woocommerce live search, woocommerce predictive, woocommerce search autocomplete, woocommerce search category, woocommerce search content, woocommerce search widget, woocommerce search form, woocommerce search page, woocommerce search product attributes, woocommerce search products, woocommerce search results, woocommerce search shortcode, woocommerce search taxonomy, woocommerce single product search, woocommerce site search, woocommerce search custom attribute, woocommerce search results page, woocommerce SERP, woocommerce search by brand, woocommerce search by sku, woocommerce search by tag, woocommerce search filter, woocommerce search hosted, woocommerce search cloud, woocommerce search ajax, quick view
...
WooCommerce search by Instant Search + boosts conversion with the fastest search-as-you-type product suggestions and search results page

== Description ==
**Note: InstandSearch+ is FREE for stores with up to 50 products, and offers affordable paid subscriptions for larger stores from $14.99 per month. 
...
3. Fully hosted Search Results Page with advanced filering options
4. Responsive design Search Results Page - mobile view
5. Analytics Dashboard to help you serve your users better.
6. Search Analytics to see what people search on your site, what they find, and what they don't.
7. Contemporary, professional search results page, with Did-you-mean
8. State of the art search results page, Did you mean, and search terms highlight
9. Automatically generated search filters for WooCommerce
