...
if ( ! defined( 'YITH_WFBT_META_VARIATION' ) ) {
	define( 'YITH_WFBT_META_VARIATION', '_yith_wfbt_default_variation' );
}
if ( ! defined( 'YITH_WFBT_META_NUM' ) ) {
	define( 'YITH_WFBT_META_NUM', '_yith_wfbt_num' );
}
