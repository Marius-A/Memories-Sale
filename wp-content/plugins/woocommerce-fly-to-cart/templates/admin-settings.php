	...
	<form method="post" action="options.php">
		...
		<h3>When to enable the "alternative method"?</h3>
			<ol>
				...
				<li>WWW.N/U/L/L/2/4.NET-You can always try this alternative variant, when you have other issues than #1 and #2.</li>
			</ol>
		</div>
		<br/><br/>
		...
		<div style="border-left:3px solid cyan; background:#fafafa;padding:3px 3px 20px 15px;">
			<h4>W/W/W.N/U/L/L/2/4.N/E/T-Having trouble configuring our "WooCommerce Fly to Cart + Ajax add to cart" plugin?</h4>
